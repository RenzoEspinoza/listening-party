          ...
          <div class="col-span-2 p-2 pt-6">
            <NowPlaying 
              connect={loggedIn.current ?
                ...
                (
                  <button onClick={() => {window.location.href='http://localhost:3001/auth/spotify'}} class="focus:outline-none outline-none bg-transparent text-green-600 border border-green-600 font-bold py-2 px-4 rounded inline-flex justify-center items-center hover:bg-green-600 hover:border-transparent hover:text-white">
